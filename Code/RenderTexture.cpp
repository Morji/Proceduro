...
bool RenderTexture::Initialize(ID3D10Device* device, int textureWidth, int textureHeight, float screenDepth, float screenNear)
{
...
void RenderTexture::SetRenderTarget(ID3D10Device* device)
{
...
void RenderTexture::ClearRenderTarget(ID3D10Device* device, float red, float green, float blue, float alpha)
{
	float color[4];
